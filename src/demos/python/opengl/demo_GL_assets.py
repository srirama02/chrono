...
print (" Demo of using the assets sys to create shapes for OpenGL visualization")
...
# (first you create the ChLineNurbs geometry, then you put it inside a ChLineShape asset)
...
vis.SetWindowTitle('Chrono::OpenGL visualization')
vis.SetWindowSize(1024,768)
vis.SetRenderMode(opengl.RenderMode_SOLID)
vis.SetParticleRenderMode(0.05, opengl.RenderMode_POINTS)
vis.Initialize()
vis.SetCameraPosition(chrono.ChVectorD(-2, 3, -4), chrono.ChVectorD(0, 0, 0))
vis.SetCameraVertical(chrono.CameraVerticalDir_Y)
vis.SetCameraProperties(0.5, 0.1, 500)
